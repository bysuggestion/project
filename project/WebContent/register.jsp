...
<div id="page" class="page">
		...
		<div class="item header margin-top-0 padding-bottom-0" id="header3">
			...
			<form action="User?action=add" method="post"  class="form-horizon">
				...
				<div class="control-group">
				 ...
				 <div class="control-group">
					...
					<div class="controls">
						<input type="password" placeholder="密码" class="input-xlarge" id="password_check"onblur="check()">
						<sup class="surely">*</sup><span id="warning"></span>
					</div>
				</div> 
				<div class="control-group">
